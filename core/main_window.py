...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(481, 544)
        MainWindow.setMaximumSize(QSize(481, 544))
        ...
        self.tableWidget.setGeometry(QRect(20, 20, 441, 361))
        ...
        self.AppendButton.setGeometry(QRect(250, 490, 211, 41))
        self.AppendButton.setFont(font)
        self.GenerateButton = QPushButton(self.centralwidget)
        self.GenerateButton.setObjectName(u"GenerateButton")
        self.GenerateButton.setGeometry(QRect(310, 390, 151, 41))
        font1 = QFont()
        ...
        self.label.setGeometry(QRect(400, 0, 61, 16))
        ...
        self.WebsiteEntry.setTabChangesFocus(True)
        ...
        self.PasswordEntry.setGeometry(QRect(250, 440, 211, 41))
        self.PasswordEntry.setFont(font)
        self.PasswordEntry.setInputMethodHints(Qt.ImhNone)
        self.PasswordEntry.setTabChangesFocus(True)
        ...
        self.UsernameEntry.setTabChangesFocus(True)
        MainWindow.setCentralWidget(self.centralwidget)
        QWidget.setTabOrder(self.WebsiteEntry, self.UsernameEntry)
        QWidget.setTabOrder(self.UsernameEntry, self.PasswordEntry)
        QWidget.setTabOrder(self.PasswordEntry, self.checkBox)
        QWidget.setTabOrder(self.checkBox, self.AppendButton)
        QWidget.setTabOrder(self.AppendButton, self.s_char_checkBox)
        QWidget.setTabOrder(self.s_char_checkBox, self.tableWidget)
        QWidget.setTabOrder(self.tableWidget, self.Length)
        QWidget.setTabOrder(self.Length, self.GenerateButton)
        QWidget.setTabOrder(self.GenerateButton, self.EditButton)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.EditButton.setText(QCoreApplication.translate("MainWindow", u"Delete Lines", None))
        ...
        self.PasswordEntry.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Passsword", None))
